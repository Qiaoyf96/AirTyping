...
@available(iOS 11.1, *)
class CameraViewController: UIViewController, AVCaptureDataOutputSynchronizerDelegate, AVCaptureFileOutputRecordingDelegate {
...
//    }
    ...
    func dataOutputSynchronizer(_ synchronizer: AVCaptureDataOutputSynchronizer,
        ...
        if JETEnabled {
            ...
            guard let jetPixelBuffer = videoDepthConverter.render(pixelBuffer: depthPixelBuffer, imgBuffer: videoPixelBuffer) else {
